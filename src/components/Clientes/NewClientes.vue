        ...
        <form @submit.prevent="saveClient">
          ...
          <div class="row mb-3">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" id="name" placeholder="Nombre del cliente"
                     v-model="clientData.name" required />
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="input-group">
              ...
              <input type="password" class="form-control" id="password" placeholder="Contraseña"
                     v-model="clientData.password" required />
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" id="address" placeholder="Dirección (opcional)"
          ...
          <div class="row mb-3">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" id="phone" placeholder="Teléfono (opcional)"
...
export default {
  ...
  methods: {
    cancel() {
      this.$router.push({ name: 'Clients' })  // Asumiendo ruta lista clientes
    },
    async saveClient() {
      try {
        // Asumiendo que backend espera un payload con datos para usuario y cliente juntos
        const payload = {
        ...
        const res = await axios.post('http://127.0.0.1:8000/api/clients', payload)
        if (res.status === 201) {
